...
class RecipientsControllerTest < ActionController::TestCase
  ...
  test "should create recipient" do
    assert_difference('Recipient.count') do
      post :create, recipient: { email: @recipient.email, name: @recipient.name, phone_number: @recipient.phone_number }
    end
  ...
  test "should update recipient" do
    put :update, id: @recipient, recipient: { email: @recipient.email, name: @recipient.name, phone_number: @recipient.phone_number }
    assert_redirected_to recipient_path(assigns(:recipient))
  end
